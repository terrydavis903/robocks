...
return {
	...
	-- Claw prize pick order (lower tier = grab first). Unmatched names = tier 8.
	-- Longer keys first when one name is a substring of another (aurorite before aurora).
	-- Friends: put portal_mage/claw_priority.lua next to modules to override this locally
	-- (always read from disk, never from GitHub — safe with the loader).
